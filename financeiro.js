...
const FINANCIAL_MONTHS = [
  ...
  },
  {
    ...
    categories: [
      ...
      { name: 'Liquidado', net: 1138834.83, vat: 182151.17, total: 1320986.00 },
    ],
    sheetRows: [
      { type: 'section', group: 'Inventario', label: 'Resumo de Movimentos 2025' },
      ...
      { group: 'Liquidado', doc: 'FT 0041/2025', entity: 'Companhia de Seguros Indico, SA', net1: 1037103.80, vat1: 165874.20, total: 1202978.00 },
      { group: 'Liquidado', doc: 'FT 0042/2025', entity: 'Vivo Energy Mocambique', net1: 25000.00, vat1: 4000.00, total: 29000.00 },
      { type: 'subtotal', group: 'Sub-total', net1: 1138834.83, net2: 0, vat1: 182151.17, vat2: 0, total: 1320986.00 },
      { type: 'tax', group: 'IVA Apuramento', net1: 0, vat1: 52371.37, vat2: 182151.17 },
      { type: 'tax', group: 'IVA a recuperar do periodo anterior', net1: 0, vat2: 28895.28 },
      { type: 'tax', group: 'IVA a pagar', net1: 0, vat2: 100884.62 },
